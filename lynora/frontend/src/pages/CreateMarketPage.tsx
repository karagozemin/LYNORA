      ...
      <div className="max-w-2xl mx-auto">
        <div className="card text-center py-12">
          ...
          <p className="text-gray-400">
            Please connect your Massa wallet to create a market
          </p>
        </div>
      </div>
    )
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {validOptions.length >= 2 && (
            <div>
              ...
              <p className="mt-1 text-sm text-gray-400">
                Winners will receive 2x their bet (max 10 MAS per winner)
              </p>
            </div>
          )}
          ...
          <div className="p-4 bg-purple-900 bg-opacity-20 border border-purple-700 rounded-lg">
            ...
            <ul className="text-sm text-gray-300 space-y-1">
              <li>• Users select an option and bet MAS tokens</li>
              <li>• After market ends, correct answer is revealed</li>
              <li>• Winners receive 2x their bet (max 10 MAS per winner)</li>
